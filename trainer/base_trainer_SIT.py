...
class BaseTrainer:
    def __init__(self,
        ...
        self.model_bs = model_bs.to(self.device)
        self.model = model.to(self.device)
        self.model_t.load_state_dict(load_checkpoint("C:\\Users\\a\\Desktop\\Wave-U-Net-for-Speech-Enhancement-master\\Wave-U-Net-for-Speech-Enhancement-master\\checkpoints\\latest_t_model.tar", self.device))
        self.model_bs.load_state_dict(load_checkpoint("C:\\Users\\a\\Desktop\\Wave-U-Net-for-Speech-Enhancement-master\\Wave-U-Net-for-Speech-Enhancement-master\\checkpoints\\latest_bs_model.tar", self.device))
        if self.n_gpu > 1:
