...
class Trainer(BaseTrainer):
    ...
    def _train_epoch(self, epoch):
        ...
        with tqdm(total = num_batchs) as pbar:
            for i, (mixture, clean, _, _, name) in enumerate(self.train_data_loader):
                ...
                enhanced_cpl, enhanced, _, _, _, _, _, _, _, _ = self.model(mixture)
    ...
    def _validation_epoch(self, epoch):
        ...
        pesq_c_e = []
        with tqdm(total = num_batchs) as pbar:  
            for i, (mixture, clean, _, _, name) in enumerate(self.validation_data_loader):
            ...
            # Visualize spectrogram
                ...
                output_path = os.path.join('H:/data3/r2', f"{name}.wav")
